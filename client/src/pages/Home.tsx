        ...
        <div className="min-h-screen bg-background relative">
            ...
            <div className={`mx-auto px-4 py-6 max-w-[1400px] w-full`}>
                ...
                <TabsList>
                    ...
                    <TabsTrigger value="politics">Infra</TabsTrigger>
                    <TabsTrigger value="crypto">Defi</TabsTrigger>
                    <TabsTrigger value="politics">GameFi</TabsTrigger>
                    <TabsTrigger value="sports">SocialFi</TabsTrigger>
                </TabsList>
